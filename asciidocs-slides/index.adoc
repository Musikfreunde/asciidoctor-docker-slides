...
[background-image="young-students-2.jpeg",background-opacity="0.4", background-size="contain"]
== Ausgangssituation
[%step]
...
[background-image="first-slide-background.jpg",background-opacity="0.8", background-size="contain"]
== Live-Demo
:hide-uri-scheme:
...
[background-image="young-students-1.jpeg",background-opacity="0.8", background-size="contain"]
