...
[.lightbg,background-image="images/young-students-2.jpg",background-opacity="0.6", background-size="contain"]
== Ausgangssituation
[%step]
...
[.lightbg,background-image="images/first-slide-background.jpg",background-opacity="0.6", background-size="contain"]
== Live-Demo
:hide-uri-scheme:
...
[.lightbg,background-image="images/young-students-1.jpeg",background-opacity="0.6", background-size="contain"]
